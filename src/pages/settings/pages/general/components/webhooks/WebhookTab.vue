  ...
  <div class="max-w-4xl mx-auto">
    ...
    <div class="space-y-4">
      ...
      <div v-if="loading" class="text-center py-8">
        <div class="text-neutral-500">{{ $t('webhooks.loading') }}</div>
      </div>

      <div v-else-if="rows.length === 0" class="text-center py-8">
        <div class="text-neutral-500">{{ $t('webhooks.no_webhooks') }}</div>
      </div>
          ...
          <div class="flex items-start justify-between">
            <div class="min-w-0 flex-1">
              <div class="flex items-center gap-3 mb-3">
                <span class="font-medium text-neutral-900 dark:text-white text-lg truncate">
                  {{ webhook.name }}
                </span>
                <AppTag
              ...
              <div class="text-sm text-neutral-600 dark:text-neutral-400 font-mono mb-3">
                {{ webhook.url }}
              </div>
